...
function DashboardHeader() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full bg-white text-white p-4 flex justify-evenly items-center z-50">
      ...
      <div className={`flex items-center rounded-2xl px-3 py-2 bg-[#F8F9FA] w-96 h-14 border ${isFocused ? 'border-[#6F42C1]' : 'border-gray-100'} font-inter `}>
        ...
        className="outline-none placeholder-[#B2B5B9] flex-grow text-black bg-[#F8F9FA]  text-base border-transparent "
