		...
		{isMobile ?
			...
			<div className=" col-span-1 ">
				...
				<div className=" my-8">
					...
					<button className="bg-transparent border-white mx-4 lg:h-14 rounded-lg lg:w-32 h-10 w-24 text-white lg:text-2xl text-xl font-Lato font-medium tracking-wide border-2 hover:border-0 hover:bg-[#6F42C1]"  onClick={()=>navigate('/login')}>
					Sign up
					</button>
				</div>
			</div>
